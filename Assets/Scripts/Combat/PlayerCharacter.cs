...
namespace EchoesOfTheVoid.Combat
{
  ...
  [AddComponentMenu("Combat/Player Character")]
  public sealed class PlayerCharacter : MonoBehaviour, ICombatant, IDamageable, IManaUser, IDefendable
  {
    [SerializeField] private string _displayName = "Player";
    [SerializeField] private int _maxHealth = 100;
    [SerializeField] private int _maxMana = 50;
    [SerializeField] private int _startingHealth = 100;
    [SerializeField] private int _startingMana = 20;
    ...
    {
      // Placeholder for player-specific turn start logic (e.g., refresh AP).
      Debug.Log($"{Name} turn begins.");
    }

    public void EndTurn()
    {
      // Placeholder for player-specific turn end logic.
    ...
    // Basic helpers that actions may call via concrete type (optional).
